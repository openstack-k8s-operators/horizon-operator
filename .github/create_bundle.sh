...
CLUSTER_BUNDLE_FILE="bundle/manifests/horizon-operator.clusterserviceversion.yaml"

echo "Creating horizon operator bundle"
cd ..
echo "${GITHUB_SHA}"
echo "${BASE_IMAGE}"
skopeo --version
...
# Output:
# Calculating image digest for docker://quay.io/openstack-k8s-operators/horizon-operator:d03f2c1c362c04fc5ef819f92a218f9ea59bbd0c
