...
func (r *Horizon) ValidateCreate() (warnings admission.Warnings, err error) {
...
func (r *Horizon) ValidateUpdate(old runtime.Object) (warnings admission.Warnings, err error) {
...
func (r *Horizon) ValidateDelete() (warnings admission.Warnings, err error) {
